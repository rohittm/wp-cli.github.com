---
layout: default
title: वर्डप्रेस के लिए कमांड लाइन इंटरफेस
---

[WP-CLI](https://wp-cli.org/) [वर्डप्रेस](https://wordpress.org/) प्रबंधन के लिए उपयोग किए जाने वाले कमांड लाइन टूल का एक संग्रह है। आप वेब ब्राउज़र का उपयोग किए बिना, प्लगिन्स अपडेट, मल्टीसाइट स्थापना को विन्यास, और बहुत कुछ कर सकते हैं।

चालू अनुरक्षण <a href="https://make.wordpress.org/cli/2017/04/03/new-co-maintainer-alain-thanks-2017-sponsors/#sponsors">इनके द्वारा संभव की गयी है</a>:
...
वर्तमान स्थिर रिलीज [version 1.4.1](https://make.wordpress.org/cli/2017/11/13/version-1-4-1-released/) है. घोषणाओं के लिए, [ट्विटर पर @wpcli](https://twitter.com/wpcli) को अनुसरण करें या [ईमेल अपडेट के लिए साइन अप करें](https://make.wordpress.org/cli/subscribe/). आगामी रिलीज के लिए बनाई गई योजना के लिए [रोडमैप देखें](https://make.wordpress.org/cli/handbook/roadmap/)।
